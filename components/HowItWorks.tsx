...
function FaqItem({ question, children }: { question: string; children: React.ReactNode }) {
  return (
    <details
      className={`border-t border-border ${faqToggleSummary} [&>summary]:px-4 [&>summary]:py-3.5 [&>summary]:text-[13px] [&>summary]:font-medium [&>summary]:text-ink [&>summary]:hover:bg-[#e8e2d8] open:[&>summary]:bg-[#e8e2d8] open:[&>summary]:hover:bg-[#e2dcd2]`}
    >
...
export function HowItWorks() {
  return (
    <details className="group mb-10 w-full rounded-[3px] border border-border bg-[#efe9df] [&>summary]:hover:bg-[#e8e2d8] open:[&>summary]:border-b open:[&>summary]:border-border open:[&>summary]:bg-[#e8e2d8] open:[&>summary]:hover:bg-[#e2dcd2]">
      <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-4 py-3.5 font-medium select-none [&::-webkit-details-marker]:hidden">
